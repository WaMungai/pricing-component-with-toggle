      ...
      <section className="p-5 lg:flex lg:flex-col items-center justify-center lg:h-screen">
        ...
        <div className="flex flex-wrap flex-col justify-center gap-8 text-center max-w-6xl mx-auto lg:gap-0 lg:flex-row lg:flex-nowrap lg:w-full">
          <article className="p-8 rounded bg-white shadow lg:w-full">
            ...
            {annually && (
              <h3 className="flex items-center justify-center text-slate-700 text-5xl">
                <span className="text-3xl mr-3">$</span>19.19
              </h3>
            )}
            {!annually && (
              <h3 className="flex items-center justify-center text-slate-700 text-5xl">
            ...
            <ul className="flex justify-center flex-col my-8">
              ...
              <li className="border-t border-slate-300 py-3 text-slate-600">Send up to 3 GB</li>
            </ul>
          ...
          <article className="linear-gradient p-8 rounded  shadow lg:w-full lg:scale-110">
            ...
            <ul className="flex justify-center flex-col my-8">
              <li className="border-t border-slate-300 py-3 text-white">1 TB Storage</li>
              <li className="border-t border-slate-300 py-3 text-white">5 Users Allowed</li>
              <li className="border-t border-slate-300 py-3 text-white">Send up to 10 GB</li>
            </ul>
          ...
          <article className="p-8 rounded bg-white shadow lg:w-full">
            ...
            {annually && (
              <h3 className="flex items-center justify-center text-slate-700 text-5xl">
                <span className="text-3xl mr-3">$</span>39.19
              </h3>
            )}
            {!annually && (
              <h3 className="flex items-center justify-center text-slate-700 text-5xl">
            ...
            <ul className="flex justify-center flex-col my-8">
              ...
              <li className="border-t border-slate-300 py-3 text-slate-600">Send up to 20 GB</li>
            </ul>
            <button className="linear-gradient btn text-white py-3 w-full rounded-lg shadow uppercase cursor-pointer border-2 hover:border-2">Learn More</button>
          </article>
        </div>
